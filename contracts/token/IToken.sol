...
interface IToken is IERC20 {
     ...
     *  emits a `Transfer` event
     */
    function mint(address _to, uint256 _amount, string memory _metadataUri) external;
     ...
     *  emits _toList.length `Transfer` events
     */
    function batchMint(address[] calldata _toList, uint256[] calldata _amounts, string[] calldata _metadataUriList) external;
